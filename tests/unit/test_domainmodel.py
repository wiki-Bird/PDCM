...
class TestReview:
    ...
    def test_construction(self):
        ...
        review1 = Review(track1, 'Sample review', 3, 'some author')
        review2 = Review(track1, ' Another review ', 2, 'some author')
        ...
        review2 = Review('Invalid track', 23, 1, 'some author')
        assert review2.track is None
        assert review2.review_text == 'N/A'

        with pytest.raises(ValueError):
            Review(track1, 'Text', 'rating', 'author')

        # Negative value of comment raises error
        with pytest.raises(ValueError):
            Review(track1, 'Text', -5, 'author')
        # Rating value > 5 raises error
        with pytest.raises(ValueError):
            Review(track1, 'Text', 10, 'author')
    ...
    def test_attributes_fail(self):
        track1 = Track(2, 'Heat Waves')
        review1 = Review(track1, 'Sweater Weather', 2, 'some author')
    ...
    def test_equality(self):
        track1 = Track(2, 'Heat Waves')
        review1 = Review(track1, 'Sweater Weather', 2, 'some author')
        review3 = Review(track1, 'Sweater Weather', 5, 'some author')
        review4 = Review(track1, 'Sweater Weather 2', 2, 'some author')
        review5 = Review(None, 'Sweater Weather', 2, 'some author')
...
class TestUser:
    ...
    def test_review_methods(self):
        ...
        track1 = Track(2, 'Heat Waves')
        review1 = Review(track1, 'review 1', 2, 'some author')
        review2 = Review(track1, 'review 2', 3, 'some author')
        review3 = Review(track1, 'review 3', 5, 'some author')
