...
class Track:
    def __init__(self, track_id: int, track_title: str):
        ...
        self.__image_file: str | None = None
    ...
    @track_file.setter
    def track_file(self, track_file: str):
        if type(track_file) is str:
            self.__track_file = track_file.strip()
    ...
    @property
    def track_duration_minutes(self) -> int:
        return f"{self.__track_duration // 60}:{self.__track_duration % 60:02}"
    ...
    @image_file.setter
    def image_file(self, new_track_image: str):
        self.__image_file = new_track_image
